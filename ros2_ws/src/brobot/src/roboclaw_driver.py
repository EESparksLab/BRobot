...
from roboclaw_3 import Roboclaw #change was needed for proper package building, see comments in CMakeLists.txt
# from utils.roboclaw_python.roboclaw_3 import Roboclaw #Use if you are running from brobot/src
