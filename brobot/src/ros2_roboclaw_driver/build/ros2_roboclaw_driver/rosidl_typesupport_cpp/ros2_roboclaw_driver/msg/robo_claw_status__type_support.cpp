...
static const _RoboClawStatus_type_support_symbol_names_t _RoboClawStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_roboclaw_driver, msg, RoboClawStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_roboclaw_driver, msg, RoboClawStatus)),
  }
};
...
{
  return &::ros2_roboclaw_driver::msg::rosidl_typesupport_cpp::RoboClawStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_roboclaw_driver, msg, RoboClawStatus)() {
  return get_message_type_support_handle<ros2_roboclaw_driver::msg::RoboClawStatus>();
}
