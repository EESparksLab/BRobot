...
def generate_launch_description():
    ...
    return LaunchDescription([
        LaunchArg('camera_name', default_value=['right_camera'],
        ...
        LaunchArg('serial', default_value="'23185348'",
                  description='FLIR serial number of camera (in quotes!!)'),
        LaunchArg('parameter_file', default_value='/source/camera_parameters.yaml',
